...
class VillagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create village" do
    assert_difference("Village.count") do
      post villages_url, params: { village: { village_name: @village.village_name, ward_id: @village.ward_id } }
    end
  ...
  test "should update village" do
    patch village_url(@village), params: { village: { village_name: @village.village_name, ward_id: @village.ward_id } }
