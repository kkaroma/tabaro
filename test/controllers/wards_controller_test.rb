...
class WardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ward" do
    assert_difference("Ward.count") do
      post wards_url, params: { ward: { division_id: @ward.division_id, ward_name: @ward.ward_name } }
    end
  ...
  test "should update ward" do
    patch ward_url(@ward), params: { ward: { division_id: @ward.division_id, ward_name: @ward.ward_name } }
